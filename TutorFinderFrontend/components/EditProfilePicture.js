...
import {Image, Pressable, View, StyleSheet, Text, Button, Modal} from 'react-native'
...
function EditProfilePicture() {
    ...
    function uploadProfilePicture() {
      launchImageLibrary({}, (response) => {
            if(response.assets) {
                setModalImage(response.assets[0].uri)
                setShowModal(true);
            }
        }) 
            ...
            <Modal visible={showModal} animationType='slide'>
                <View style={[styles.col, styles.modalContainer]}>
                    <View style={styles.row}>
                        <Image style={[styles.modalPictureBox]} source={{uri: modalImage}}/>
                    </View>
    ...
    return (
        <View style={[styles.col]}>
            ...
            <View style={styles.row}>
            <Pressable style={styles.profileImageButton} onPress={uploadProfilePicture}>
